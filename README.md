...
- After finishing with the project and doing my final checks prior to submiting my project. I discovered that the placeholder high scores were overwriting any high scores that were saved after the site reloads. The error was corrected and the site is back to working seamlessly.
